...
import pro.axenix.configuration.*;
import pro.axenix.ui.page.LoginPage;
...
@ExtendWith(CredentialsParameter.class)
class TestFirst {
    private static EnvironmentConfiguration configuration;
    private final Credentials credentials;

    TestFirst(Credentials credentials) {
    ...
    void testLogin() {
        LoginPage loginPage = open(configuration.getHttpHostUrl("login"), LoginPage.class);
